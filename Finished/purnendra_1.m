...
fprintf('The arrival rate of each age group at the centre is proportional to their population percentage, and the sum of arrival rates is proportional to %d .',rate_normaliser)
fprintf("Given that vaccines are delivered at the rate of 13/hour , find the probability that in the duration of 1 hour, the more people from the older population get populated than the younger ones.")
